...
class RandomGen5Teams extends import_random_teams.default {
  ...
  getItem(ability, types, moves, counter, teamDetails, species, isLead, preferredType, role) {
    ...
    if (role === "Fast Support" && isLead && defensiveStatTotal < 255 && !counter.get("recovery") && (!counter.get("recoil") || ability === "Rock Head") && (counter.get("hazards") || !(moves.has("uturn") || moves.has("voltswitch"))))
      return "Focus Sash";
